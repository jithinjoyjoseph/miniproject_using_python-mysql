...
# (pid int(8) primary key,pnm varchar(30) not null,level varchar(30) not null,freespace varchar(30) not null,vehicleno varchar(30) not null,nod varchar(30) not null, payment int(5) not null)
# create vehicle
...
mydb = pymysql.connect(host="localhost", user="root", password="98b$ktwysbtwys&lj", database='parking')
